...
from keyboards.reply import rkr
...
async def form_name(message: Message, state: FSMContext):
    ...
    await message.answer("Отлично, теперь введи свой возраст", reply_markup=rkr)
...
async def form_sex(message: Message, state: FSMContext):
    ...
    await message.answer("Расскажи о себе", reply_markup=rkr)
